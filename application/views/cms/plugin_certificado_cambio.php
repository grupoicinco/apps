<?php
  include_once(str_replace("\\","/",APPPATH).'../../WebClientPrint'.EXT);
  session_start();
...
<div class="container-fluid" id="content">
	<div class="page-header">
		<h1>Certificados de Cambio<small></small></h1>
	</div>
	<div class="row">
		<div class="col-lg-12">
...
//		        if($rawQuery[WebClientPrint::CLIENT_PRINT_JOB]){
		            ...
		            if ($useDefaultPrinter || $printerName === 'null'){
		                ...
		                $cpj->clientPrinter = $this->installedprinter($printerName);
		            }
		...
		?>
		    ...
		    <script type="text/javascript">
		        ...
		        function wcpGetPrintersOnFailure() {
		            ...
		            alert("No se pudieron obtener impresoras.");
		        }
		    </script>
		    ...
		    echo WebClientPrint::createScript(base_url('/cms/plugin_certificado_cambio/index/').'/');
		    ?>
