...
class Panel_usuarios extends PL_Controller {
	...
	function __construct(){
		...
		$this->plugin_button_create			= "Crear Nuevo Registro de reparación";
		...
		$this->plugin_page_create			= "Crear Nuevo Registro de reparación";
		$this->plugin_page_read				= "Mostrar Registro de reparación";
		$this->plugin_page_update			= "Editar Registro de reparación";
